...
* At 0탎 the dataline is pulled high.  (cycle 3)
* To send a zero the dataline is pulled low after 0.312탎 (3+3=6 cycles) (error 0.06탎)
* To send a one the dataline is pulled low after 0.625탎 (3+6=9 cycles) (no error).
...
* 18 cycles for bit 0
	...
	- The bit 0 timing exceeds the 1.25탎 timing by 625탎, which is slightly
	above the tolerances in the datasheet (600탎).
...
/*
	...
	* 6 cycles for bit 0	
	...
	the tolerances stated in the datasheet.
